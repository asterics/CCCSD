...
echo '
				...
				<div class="buttonrow_r">
					...
					<a download="' . $fileName["fileName"] . '" href="../../Backend/Models/M' . $id . '.acs" class="btn" onclick="countDownloads('.$id .')">Download</a>
					<a href="javascript:pushModel(\'../../Backend/Models/M' . $id . '.acs\')" class="btn">Send to ARE</a>
					<a href="../../../WebACS_JS/WebACS.html?../Wizard_git/Backend/Models/M' . $id . '.acs" class="btn" target="_blank">Send to ACS</a>
					</div>
				</nav>
			';
?>